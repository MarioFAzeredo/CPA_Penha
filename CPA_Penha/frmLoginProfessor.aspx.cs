...
namespace CPA_Penha
{
    public partial class frmLoginProfessor : System.Web.UI.Page
    {
        ...
        protected void btnAcessar_Click(object sender, EventArgs e)
        {
            ...
            controle.acessarProfessor(txtRa.Text, txtSenha.Text);
            if (controle.mensagem.Equals(""))
            {
                ...
                if (controle.tem)
                {
                    ...
                    Response.Redirect("~/frmProfessorRestrito.aspx");
                }
                else
                {
        ...
        {
            Response.Redirect("~/frmRecuperarProfessor.aspx");
        }
    }
}