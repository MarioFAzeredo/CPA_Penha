<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLoginCoordenador.aspx.cs" Inherits="CPA_Penha.frmLoginCoordenador" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="lkbAluno" runat="server" Font-Bold="false" Font-Size="35px" OnClick="lkbProfessor_Click">Aluno</asp:LinkButton>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="lkbProfessor" runat="server" Font-Bold="false" Font-Size="35px" OnClick="lkbCoordenador_Click">Professor</asp:LinkButton>
            </div>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
&nbsp;<label style="margin-left:50px; font-size: 22px;"><b>Digie dados do Coordenador</b></label>
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
